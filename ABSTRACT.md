...
Lean 4 / Mathlib: over **5,000 theorems across ~505 files**, zero axioms beyond Lean's standard
...
The current-HEAD raw counts are **5,565 theorem/lemma declarations, 505 `.lean` files, ~3,360
...
"over 5,000 theorems across ~505 files" is the current phrasing. New this recount (2026-07-10): the
