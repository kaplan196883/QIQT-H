...
Lean 4 / Mathlib: over **5,000 theorems across ~490 files**, zero axioms beyond Lean's standard
...
The current-HEAD raw counts are **5,244 theorem/lemma declarations, 490 `.lean` files, 3,262
