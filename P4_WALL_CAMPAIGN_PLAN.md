...
with `A=stoneGen` the Cayley self-adjoint operator (Stone's correspondence both directions) — the
derivative-through-strong-limit + e.s.a. wall (Phase 3.2); then X=A_edge → Phase 5;
