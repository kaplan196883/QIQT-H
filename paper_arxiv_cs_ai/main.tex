...
\emph{jointly satisfiable}, so the theorem is non-vacuous. The same development carries a
...
the audit shows no project axiom and no syntactically vacuous premise, which for an \emph{arbitrary}
