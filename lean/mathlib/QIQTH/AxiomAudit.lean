...
-- expected: standard only — STONE GENERATOR: d/dt Δ^{it}|₀ = i·K (K=logΔ=relModGen the modular
-- Hamiltonian); the modular flow is the unitary group generated by i·logΔ. Axiom-free.
