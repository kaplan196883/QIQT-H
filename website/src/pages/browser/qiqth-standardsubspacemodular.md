...
$$
\mathrm{rvdR}\,H\,\mathrm{NormedAddCommGroup}\,H\,\mathrm{InnerProductSpace}\,H\,\mathrm{CompleteSpace}\,H\,S \;:=\; \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S + \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S
$$
...
$$
\mathrm{IsIdempotentElem}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S)
$$
...
$$
\mathrm{IsIdempotentElem}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S)
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,\xi = (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S)\,\xi + (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S)\,\xi
$$
...
$$
\langle {(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,\xi},{\xi}\rangle = {\|(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S)\,\xi\|}^{2} + {\|(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S)\,\xi\|}^{2}
$$
...
$$
0 \le \langle {(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,\xi},{\xi}\rangle
$$
...
$$
\|(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S)\,\xi\| \le \|\xi\|
$$
...
$$
\|(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S)\,\xi\| \le \|\xi\|
$$
...
$$
\langle {(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,\xi},{\xi}\rangle \le 2 \cdot {\|\xi\|}^{2}
$$
...
$$
\langle {(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,x},{y}\rangle = \langle {x},{(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,y}\rangle
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,\xi = 0 \to \xi = 0
$$
...
$$
\mathrm{IsSelfAdjoint}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S)
$$
...
$$
\mathrm{IsSelfAdjoint}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S)
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S)\,(i \cdot \xi) = i \cdot (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S)\,\xi
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S)\,(i \cdot \xi) = i \cdot (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S)\,\xi
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,(i \cdot \xi) = i \cdot (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,\xi
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,(c \cdot x) = c \cdot (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,x
$$
...
$$
\mathrm{rvdRC}\,H\,\mathrm{NormedAddCommGroup}\,H\,\mathrm{InnerProductSpace}\,H\,\mathrm{CompleteSpace}\,H\,S \;:=\; \{\mathrm{toFun} :=(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S) , \mathrm{map\_add}^{\prime} :=\cdots , \mathrm{map\_smul}^{\prime} :=\cdots , \mathrm{cont} :=\cdots \}
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S)\,x = (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,x
$$
...
$$
((\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S)).\mathrm{IsSymmetric}
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S).\mathrm{IsPositive}
$$
...
$$
0 \le \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S
$$
...
$$
\mathrm{rvdPmQ}\,H\,\mathrm{NormedAddCommGroup}\,H\,\mathrm{InnerProductSpace}\,H\,\mathrm{CompleteSpace}\,H\,S \;:=\; \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projk}{\mathrm{projK}}\,S - \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-projik}{\mathrm{projIK}}\,S
$$
...
$$
\mathrm{IsSelfAdjoint}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,\xi = 0 \to \xi = 0
$$
...
$$
\mathrm{Injective}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)
$$
...
$$
(2 \cdot 1 - \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S).\mathrm{IsPositive}
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,(i \cdot \xi) = -(i \cdot (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,\xi)
$$
...
$$
(2-R)\,H\,\mathrm{NormedAddCommGroup}\,H\,\mathrm{InnerProductSpace}\,H\,\mathrm{CompleteSpace}\,H\,S \;:=\; 2 \cdot 1 - \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdtwosubrc}{(2-R)}\,S)\,x = 2 \cdot x - (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S)\,x
$$
...
$$
R^{1/2}\,H\,\mathrm{NormedAddCommGroup}\,H\,\mathrm{InnerProductSpace}\,H\,\mathrm{CompleteSpace}\,H\,S \;:=\; \mathrm{sqrt}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S)
$$
...
$$
\sqrt{2-R}\,H\,\mathrm{NormedAddCommGroup}\,H\,\mathrm{InnerProductSpace}\,H\,\mathrm{CompleteSpace}\,H\,S \;:=\; \mathrm{sqrt}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdtwosubrc}{(2-R)}\,S)
$$
...
$$
\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdsqrtr}{R^{1/2}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdsqrtr}{R^{1/2}}\,S = \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S
$$
...
$$
\mathrm{Commute}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S)\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdtwosubrc}{(2-R)}\,S)
$$
...
$$
\mathrm{rvdT}\,H\,\mathrm{NormedAddCommGroup}\,H\,\mathrm{InnerProductSpace}\,H\,\mathrm{CompleteSpace}\,H\,S \;:=\; \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdsqrtr}{R^{1/2}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdsqrttwosubr}{\sqrt{2-R}}\,S
$$
...
$$
\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdt}{\mathrm{rvdT}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdt}{\mathrm{rvdT}}\,S = \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdtwosubrc}{(2-R)}\,S
$$
...
$$
0 \le \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdt}{\mathrm{rvdT}}\,S
$$
...
$$
\mathrm{IsSelfAdjoint}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdt}{\mathrm{rvdT}}\,S)
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdtwosubrc}{(2-R)}\,S)\,\xi = (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,((\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,\xi)
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,((\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdtwosubrc}{(2-R)}\,S)\,\xi) = (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdrc}{\mathrm{rvdRC}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdtwosubrc}{(2-R)}\,S)\,((\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,\xi)
$$
...
$$
\mathrm{Injective}\,(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdt}{\mathrm{rvdT}}\,S)
$$
...
$$
\|(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdt}{\mathrm{rvdT}}\,S)\,\xi\| = \|(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,\xi\|
$$
...
$$
\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S = (2 \cdot 1 - \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S) \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S
$$
...
$$
\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S \cdot (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S - 1) = -((\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdr}{\mathrm{rvdR}}\,S - 1) \cdot \href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)
$$
...
$$
(\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,(c \cdot \xi) = (\mathrm{starRingEnd}\,\mathbb{C})\,c \cdot (\href{/browser/qiqth-standardsubspacemodular#d-qiqth-standardsubspacemodular-rvdpmq}{\mathrm{rvdPmQ}}\,S)\,\xi
$$
