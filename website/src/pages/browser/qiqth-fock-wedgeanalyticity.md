...
$$
\mathrm{KrepCont}\,m\,f\,\zeta \;:=\; 1 / \sqrt 2 \cdot \int (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), \exp\,(-i \cdot \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-minkowskidot}{\eta}\,(\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-massshell}{\mathrm{MS}}\,m\,\zeta)\,x) \cdot f\,x
$$
...
$$
\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f\,\theta = \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,f\,\theta
$$
...
$$
\mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall (\zeta_{0} : \mathbb{C}), ({\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f})'({\zeta_{0}})={1 / \sqrt 2 \cdot \int (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-kernelderiv}{\mathrm{K}{}'}\,m\,x\,\zeta_{0} \cdot f\,x}
$$
...
$$
\mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \mathrm{Differentiable}\,\mathbb{C}\,(\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f)
$$
...
$$
\mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \mathrm{Continuous}\,(\mathrm{deriv}\,(\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f))
$$
...
$$
\mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall (\zeta : \mathbb{C}), \mathrm{deriv}\,(\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f)\,\zeta = 1 / \sqrt 2 \cdot \int (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-kernelderiv}{\mathrm{K}{}'}\,m\,x\,\zeta \cdot f\,x
$$
...
$$
(\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), (\mathrm{starRingEnd}\,\mathbb{C})\,(f\,x) = f\,x) \to \forall (\theta : \mathbb{R}), \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f\,(\theta + \pi \cdot i) = (\mathrm{starRingEnd}\,\mathbb{C})\,(\href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,f\,\theta)
$$
...
$$
\|\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-kernel}{\mathrm{kernel}}\,m\,x\,(\theta + \mathrm{lam} \cdot i)\| = \exp\,(m \cdot \sin\,\mathrm{lam} \cdot (\sinh\,\theta \cdot x\,0 - \cosh\,\theta \cdot x\,1))
$$
...
$$
0 \le m \to \forall \{x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}\} \{\delta : \mathbb{R}\}, \delta \le x\,1 - x\,0 \to \delta \le x\,1 + x\,0 \to \forall \{\theta \mathrm{lam} : \mathbb{R}\}, 0 \le \mathrm{lam} \to \mathrm{lam} \le \pi \to \|\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-kernel}{\mathrm{kernel}}\,m\,x\,(\theta + \mathrm{lam} \cdot i)\| \le \exp\,(-(m \cdot \sin\,\mathrm{lam} \cdot \delta) \cdot \cosh\,\theta)
$$
...
$$
0 \le m \to \forall \{f : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V} \to \mathbb{C}\}, \mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall \{\delta : \mathbb{R}\}, (\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), f\,x \ne 0 \to \delta \le x\,1 - x\,0 \wedge \delta \le x\,1 + x\,0) \to \forall \{\theta \mathrm{lam} : \mathbb{R}\}, 0 \le \mathrm{lam} \to \mathrm{lam} \le \pi \to \|\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f\,(\theta + \mathrm{lam} \cdot i)\| \le (1 / \sqrt 2 \cdot \int (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), \|f\,x\|) \cdot \exp\,(-(m \cdot \sin\,\mathrm{lam} \cdot \delta) \cdot \cosh\,\theta)
$$
...
$$
0 \le m \to \forall \{f : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V} \to \mathbb{C}\}, \mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall \{\delta : \mathbb{R}\}, (\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), f\,x \ne 0 \to \delta \le x\,1 - x\,0 \wedge \delta \le x\,1 + x\,0) \to \forall \{\zeta : \mathbb{C}\}, 0 \le \zeta.\mathrm{im} \to \zeta.\mathrm{im} \le \pi \to \|\mathrm{deriv}\,(\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f)\,\zeta\| \le 1 / \sqrt 2 \cdot (|m| \cdot \cosh\,\zeta.\mathrm{re} \cdot \exp\,(-(m \cdot \sin\,\zeta.\mathrm{im} \cdot \delta) \cdot \cosh\,\zeta.\mathrm{re}) \cdot \int (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), (|x\,0| + |x\,1|) \cdot \|f\,x\|)
$$
...
$$
0 \le m \to \forall \{f : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V} \to \mathbb{C}\}, \mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall \{\delta : \mathbb{R}\}, (\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), f\,x \ne 0 \to \delta \le x\,1 - x\,0 \wedge \delta \le x\,1 + x\,0) \to \forall \{w : \mathbb{C}\}, 0 \le w.\mathrm{im} \to w.\mathrm{im} \le \pi \to \|\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f\,w\| \le (1 / \sqrt 2 \cdot \int (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), \|f\,x\|) \cdot \exp\,(-(m \cdot \sin\,w.\mathrm{im} \cdot \delta) \cdot \cosh\,w.\mathrm{re})
$$
...
$$
0 \le m \to \forall \{f : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V} \to \mathbb{C}\}, \mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall \{\delta : \mathbb{R}\}, 0 \le \delta \to (\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), f\,x \ne 0 \to \delta \le x\,1 - x\,0 \wedge \delta \le x\,1 + x\,0) \to \forall \{w : \mathbb{C}\}, 0 \le w.\mathrm{im} \to w.\mathrm{im} \le \pi \to \|\href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f\,w\| \le 1 / \sqrt 2 \cdot \int (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), \|f\,x\|
$$
...
$$
0 < m \to \forall \{f : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V} \to \mathbb{C}\}, \mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall \{\delta : \mathbb{R}\}, 0 < \delta \to (\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), f\,x \ne 0 \to \delta \le x\,1 - x\,0 \wedge \delta \le x\,1 + x\,0) \to \forall \{c_{0} : \mathbb{C}\}, 0 < c_{0}.\mathrm{im} \to c_{0}.\mathrm{im} < \pi \to \mathrm{MemLp}\,(\lambda \theta \mapsto \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f\,(\theta + c_{0}))\,2\,\mathrm{volume}
$$
...
$$
\mathrm{Continuous}\,f_{1} \to \mathrm{HasCompactSupport}\,f_{1} \to \mathrm{Continuous}\,f_{2} \to \mathrm{HasCompactSupport}\,f_{2} \to \forall (\zeta : \mathbb{C}), \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,(f_{1} + f_{2})\,\zeta = \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f_{1}\,\zeta + \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f_{2}\,\zeta
$$
...
$$
\mathrm{Continuous}\,f_{1} \to \mathrm{HasCompactSupport}\,f_{1} \to \mathrm{Continuous}\,f_{2} \to \mathrm{HasCompactSupport}\,f_{2} \to \forall (\theta : \mathbb{R}), \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,(f_{1} + f_{2})\,\theta = \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,f_{1}\,\theta + \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,f_{2}\,\theta
$$
...
$$
\mathrm{Continuous}\,f_{1} \to \mathrm{HasCompactSupport}\,f_{1} \to \mathrm{Continuous}\,f_{2} \to \mathrm{HasCompactSupport}\,f_{2} \to \mathrm{MemLp}\,(\href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,f_{1})\,2\,\mathrm{volume} \to \mathrm{MemLp}\,(\href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,f_{2})\,2\,\mathrm{volume} \to \mathrm{MemLp}\,(\href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,(f_{1} + f_{2}))\,2\,\mathrm{volume}
$$
...
$$
0 < m \to \forall \{f : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V} \to \mathbb{C}\}, \mathrm{Continuous}\,f \to \mathrm{HasCompactSupport}\,f \to \forall \{\delta : \mathbb{R}\}, 0 < \delta \to (\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), f\,x \ne 0 \to \delta \le x\,1 - x\,0 \wedge \delta \le x\,1 + x\,0) \to (\forall (x : \href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-v}{V}), (\mathrm{starRingEnd}\,\mathbb{C})\,(f\,x) = f\,x) \to \mathrm{MemLp}\,(\href{/browser/qiqth-fock-localization#d-qiqth-fock-localization-krep}{\mathrm{Krep}}\,m\,f)\,2\,\mathrm{volume} \to \forall \{c_{0} : \mathbb{C}\}, 0 \le c_{0}.\mathrm{im} \to c_{0}.\mathrm{im} \le \pi \to \mathrm{MemLp}\,(\lambda \theta \mapsto \href{/browser/qiqth-fock-wedgeanalyticity#d-qiqth-fock-wedgeanalyticity-krepcont}{\mathrm{KrepCont}}\,m\,f\,(\theta + c_{0}))\,2\,\mathrm{volume}
$$
