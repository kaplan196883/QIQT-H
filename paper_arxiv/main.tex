...
192 modules and roughly 2{,}010 theorems. We report two episodes in which the independent reviewer
...
\item \textbf{An existence proof at the scale of a whole theory.} End-to-end formalization of a
  ...
  its deductive core from 57 project axioms to 0, with no \texttt{sorry}, over 192 modules and
  about 2{,}010 theorems (\S4).
...
fifty-seven project-specific axioms to zero, with no \texttt{sorry}, across 192 modules and roughly
2{,}010 theorems, and it produced two documented, kernel-checkable soundness saves: a false axiom that
