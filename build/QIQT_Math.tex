...
\begin{enumerate}
  ...
  \item \textbf{A non-dynamical run-index $\lambda$} (the run's actual microscopic initial conditions) selecting which single record is realized.
\end{enumerate}
