...
The \emph{foundational} statement of the bound is modular-local (foundations paper §7.6): for the screen region $R_S$ with local algebra $\hat{\mathcal{A}}(R_S)$ and a reference state $\Omega_{R_S}$,
