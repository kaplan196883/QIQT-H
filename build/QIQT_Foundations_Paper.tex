...
\begin{itemize}
  \item \textasciitilde{}\textasciitilde{}"No-signaling theorem under regional admissibility"\textasciitilde{}\textasciitilde{} \textbf{RESOLVED in §7.7} via modular-local admissibility + AQFT microcausality. The earlier Bell-style counter-example with hard joint-diamond cutoff motivated the modular-local refactor.
