...
These four commitments turn the framework's working informal description into a \emph{specifically constrained} algebraic theory. They are the price of having the modular-local form closes the no-signaling loophole properly.
