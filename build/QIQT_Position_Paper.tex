...
The values are enormous in conventional terms — $\sim 10^{70}$ nats for a one-meter region — but \textbf{finite}, and they \textbf{scale as boundary area rather than volume}. This is the \emph{holographic} character of the bound.
