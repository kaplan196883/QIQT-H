...
Over **5,000 theorems across ~515 files**, axiom-free (Lean's standard three only; project axiom budget 0, checked by the `verify.sh` audit). Formalization firsts — to our knowledge, in any proof assistant:
